...
// Add iframe with source
app.directive('citeFrame', function($compile, $sce){
  return {
    scope: {},
    templateUrl: 'src/citeframe.html',
    link: function($scope, iElm, iAttrs, controller) {
      $scope.link = $sce.trustAsResourceUrl(iAttrs.href);
      $scope.height = iAttrs.h || 400;
    }
  };
});
